...
export const DEFAULT_TOGGLE_SHORTCUT = 'Ctrl+Shift+9'
...
// Chrome hands back `Command+Shift+9` on macOS and `Ctrl+Shift+9` elsewhere;
...
// Some surfaces report the macOS binding as glyphs with no separators (`⌘⇧7`).
