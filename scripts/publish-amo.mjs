...
const GUID = 'instagram-feed-blocker@shbernal.github.io'
...
Environment
  ...
  AMO_PACKAGE               package to submit
                            (default: release/instagram-feed-blocker-firefox-${version}.zip)
  AMO_SOURCE                source archive to attach
                            (default: release/instagram-feed-blocker-source-${version}.zip)
...
const packagePath = path.resolve(
  ...
  process.env.AMO_PACKAGE ??
    `release/instagram-feed-blocker-firefox-${version}.zip`,
)
const sourcePath = path.resolve(
  root,
  process.env.AMO_SOURCE ??
    `release/instagram-feed-blocker-source-${version}.zip`,
)
