...
import { installInstagramFixtureRoutes } from './instagramPages'

type ExtensionFixtures = {
  extensionContext: BrowserContext
  extensionId: string
  newInstagramPage: () => Promise<Page>
...
export const test = base.extend<ExtensionFixtures>({
  extensionContext: async ({ headless }, use, testInfo) => {
    ...
    await installInstagramFixtureRoutes(context)
  ...
  newInstagramPage: async ({ extensionContext }, use) => {
