...
const manualStartUrl =
  process.env.INSTAGRAM_MANUAL_URL ?? 'https://www.instagram.com/'
...
test('manual Instagram extension session', async ({
  extensionContext,
  extensionId,
  ...
  console.log(`Manual Instagram session: ${manualStartUrl}`)
